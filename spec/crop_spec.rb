...
#   before(:each) do
#     DB[:conn].execute("DROP TABLE IF EXISTS crops")
#   end

#   describe "Attributes" do
#       it 'has a name, boxes and price' do
#         carrots = Crop.new("Carrots", 10, 2, bubba)
#         expect(carrots.name).to eq("Erik")
#         expect(carrots.boxes).to eq(10)
#         expect(carrots.price).to eq(2)
#         expect(carrots.farmer).to eq(bubba)
#       end
#     end
#   end
